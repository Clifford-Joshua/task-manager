  ...
  return (
    <Wrapper className="w-[100%] md:w-[70%] flex flex-col gap-[0.5rem] items-center ">
      ...
      <div className="flex flex-col gap-[0.3rem] text-center">
        <h2 className="font-bold text-[1.6rem]">Account Settings</h2>
        <p className="text-gray-600 text-[0.9rem] md:text-[1rem]">
          Update your personal information, change your password, or remove your
          account. Keep your profile details secure and up to date.
        </p>
      </div>
    </Wrapper>
  );
